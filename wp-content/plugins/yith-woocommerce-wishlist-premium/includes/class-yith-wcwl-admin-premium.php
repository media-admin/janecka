				...
				if ( ! empty( $promotion_email_draft ) ) {
					...
					<div class="updated fade">
						<p>
							...
							<a href="#" class="restore-draft button-primary" data-draft="<?php echo wc_esc_json( wp_json_encode( $promotion_email_draft ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">

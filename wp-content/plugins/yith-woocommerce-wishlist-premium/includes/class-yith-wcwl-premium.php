...
if ( ! class_exists( 'YITH_WCWL_Premium' ) ) {
	...
	class YITH_WCWL_Premium extends YITH_WCWL {
		...
		public function get_unsubscribe_link( $user_id ) {
			...
			return apply_filters( 'yith_wcwl_unsubscribe_url', wp_nonce_url( add_query_arg( 'yith_wcwl_unsubscribe', $unsubscribe_token, get_home_url() ), 'unsubscribe' ), $user_id, $unsubscribe_token, $unsubscribe_token_expiration );
		}

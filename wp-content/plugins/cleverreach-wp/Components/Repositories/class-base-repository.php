...
use CleverReach\WordPress\IntegrationCore\Infrastructure\ORM\QueryFilter\QueryCondition;
use CleverReach\WordPress\IntegrationCore\Infrastructure\ORM\QueryFilter\QueryFilter;
use CleverReach\WordPress\IntegrationCore\Infrastructure\ORM\Utility\IndexHelper;
...
class Base_Repository implements RepositoryInterface {
	...
	public function __construct() {
		global $wpdb;
		$this->db         = $wpdb;
		$this->table_name = $this->db->prefix . Database::ENTITY_TABLE;
	}

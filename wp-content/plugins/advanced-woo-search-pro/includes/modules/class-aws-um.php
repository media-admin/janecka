...
if ( ! class_exists( 'AWS_UM' ) ) :
    ...
    class AWS_UM {
        ...
        public function __construct() {
            ...
            //add_filter( 'aws_search_users_results', array( $this, 'aws_search_users_results' ) );
         ...
         */
        public function aws_search_users_results( $result_array ) {
            if ( $result_array && function_exists( 'um_user_profile_url' ) ) {
                foreach ( $result_array as $result_users_id => $result_users ) {
                    foreach ( $result_users as $result_user_key => $result_user ) {
                        $result_array[$result_users_id][$result_user_key]['link'] = um_user_profile_url( $result_users_id );
                    }
                }
            }
            return $result_array;

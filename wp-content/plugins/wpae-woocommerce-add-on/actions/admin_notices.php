...
function pmwe_admin_notices() {
	...
	if ( ! class_exists( 'PMXE_Plugin' ) ) {
		...
		<div class="error"><p>
			<?php printf(
					__('<b>%s Plugin</b>: WP All Export Pro must be installed and activated. You can download it here <a href="https://www.wpallimport.com/portal" target="_blank">https://www.wpallimport.com/portal/</a>', 'PMWE_Plugin'),

...
if ( ! $dependencies->is_woocommerce_gzd_activated() ) {
    $title = __( 'Germanized basic is missing', 'woocommerce-germanized-pro' );

	$install_url = wp_nonce_url( add_query_arg( array(
		'action' => 'install-plugin',
		'plugin' => 'woocommerce-germanized'
	), admin_url( 'update.php' ) ), 'install-plugin_woocommerce_germanized' );
	...
	if ( in_array( 'woocommerce-germanized/woocommerce-germanized.php', $plugins ) ) {
		$install_url = wp_nonce_url( add_query_arg( array(
			'action' => 'activate',
			'plugin' => urlencode( 'woocommerce-germanized/woocommerce-germanized.php' )
		), admin_url( 'plugins.php' ) ), 'activate-plugin_woocommerce-germanized/woocommerce-germanized.php' );
	...
	$title = __( 'Germanized basic is outdated', 'woocommerce-germanized-pro' );

...
const ItemTotalTaxEdit = ( {
    ...
    const total = item[ getItemTotalKey( 'total_tax', showPricesIncludingTax, discountTotalType ) ];

    const classes = classnames( 'sab-block-item-content placeholder-wrapper sab-block-item-total-tax', className, {
        ...
        <>
            ...
            <div>
                <TextColor>
                  <RichText
                    tagName="p"
                    value={ replacePlaceholderWithPreview( content, total, '{content}', false, _x( 'Item Tax Total', 'storeabill-core', 'storeabill' ) ) }
                    placeholder={ replacePlaceholderWithPreview( undefined, total, '{content}', false, _x( 'Item Tax Total', 'storeabill-core', 'storeabill' ) ) }
                    className={ classes }
                    onChange={ ( value ) =>

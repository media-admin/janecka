 ...
 * AllProducts class.
 */
class ItemTotalTax extends ItemTableColumnBlock {
	 ...
	 * @var string
	 */
	protected $block_name = 'item-total-tax';
	...
	public function render( $attributes = array(), $content = '' ) {
		...
		if ( is_a( $document_item, '\Vendidero\StoreaBill\Interfaces\Priceable' ) ) {
			$getter = $this->get_item_total_getter( 'total_tax', $attributes['showPricesIncludingTax'], $attributes['discountTotalType'] );
			$output = '';

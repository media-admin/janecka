		...
		<?php foreach ( $active_filters as $filter => $options ) : ?>
			...
			<div class="active-filter">
				...
				<?php foreach ( $options['values'] as $value ) : ?>
					<a href="<?php echo esc_url( YITH_WCAN_Query()->get_filter_url( array(), $value['query_vars'] ) ); ?>" class="active-filter-label" data-filters="<?php echo esc_attr( wp_json_encode( $value['query_vars'] ) ); ?>">

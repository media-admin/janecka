...
$gallery_settings = array(
	...
	array(
		'name'      => __( 'Change main image on', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Choose how to change the main product image.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_change_image_on',
		'type'      => 'yith-field',
		'yith-type' => 'radio',
		'options'   => array(
			'click' => esc_html__( 'Click - the user has to click on the thumbnail to change the main product image.', 'yith-woocommerce-zoom-magnifier' ),
			'hover'  =>  esc_html__( 'Hover - the image will be replaced when the mouse hovers over the thumbnail.', 'yith-woocommerce-zoom-magnifier' ),
		),
		'default'   => 'click',
		'deps'      => array(
			'id'    => 'ywzm_hide_thumbnails',
	...
	array(
		'name'      => __( 'Add opacity on inactive thumbnails', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Enable to add opacity to inactive thumbnails.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_thumbnails_opacity',
		'default'   => 'no',
		'type'      => 'yith-field',
		'yith-type' => 'onoff',
		'deps'      => array(
	...
	array(
		'name'      => __( 'Apply grey scale on inactive thumbnails', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Enable to apply a grey scale to inactive thumbnails.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_thumbnails_grey_scale',
		'default'   => 'no',
		'type'      => 'yith-field',
		'yith-type' => 'onoff',
		'deps'      => array(
	...
	array(
		'name'      => __( 'Add zoom effect to the thumbnails', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Enable to add a zoom effect when hovering over the thumbnails.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_thumbnails_zoom_effect',
		'default'   => 'no',
		'type'      => 'yith-field',
		'yith-type' => 'onoff',
		'deps'      => array(
	...
	array(
		'name'      => __( 'Active thumb border color', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Set the color for the active thumbnail.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_active_thumbnails_border_color',
		'type'      => 'yith-field',
	...
	array(
		'name'    => __( 'Border radius (%)', 'yith-woocommerce-zoom-magnifier' ),
		'desc'    => __( 'Set the border radius to change the shape of the slider.', 'yith-woocommerce-zoom-magnifier' ),
		'id'      => 'yith_wcmg_slider_radius',
		'type'    => 'yith-field',
		'yith-type' => 'number',
		'default'   => '50',
		'min'      => 0,
	...
	array(
		'name'      => __( 'Show slider arrows', 'yith-woocommerce-zoom-magnifier' ),
		'desc'      => __( 'Choose how to display the slider arrows.', 'yith-woocommerce-zoom-magnifier' ),
		'id'        => 'ywzm_slider_arrows_display',
		'type'      => 'yith-field',
		'yith-type' => 'radio',
		'options'   => array(
			'fixed' => esc_html__( 'Fixed - keep the slider arrows displayed.', 'yith-woocommerce-zoom-magnifier' ),
			'hover'  =>  esc_html__( 'On Hover - display the slider arrows when hover over the thumbnails gallery.', 'yith-woocommerce-zoom-magnifier' ),
		),
		'default'   => 'hover',
		'deps'      => array(
			'id'    => 'yith_wcmg_enableslider',

  ...
  $.yith_magnifier.prototype = {
    ...
    _initTrap: function () {
      ...
      if ( typeof ywzm_data != 'undefined' ) {
        ...
        $( '<span class="yith_zoom_icon" style="display: inline;"></span>' ).appendTo( this.mouseTrap );
        ...
        $( '.zoom-button-hidden' ).clone().appendTo( $( '.yith_zoom_icon') );
        $( '.yith_magnifier_mousetrap .yith_zoom_icon .zoom-button-hidden' ).show();

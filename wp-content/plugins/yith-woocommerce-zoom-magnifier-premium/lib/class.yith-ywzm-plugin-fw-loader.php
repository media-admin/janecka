...
if ( ! class_exists( 'YITH_YWZM_Plugin_FW_Loader' ) ) {
	...
	class YITH_YWZM_Plugin_FW_Loader {
		 ...
		 * @var string
		 */
		protected $premium_landing = 'https://yithemes.com/themes/plugins/yith-woocommerce-zoom-magnifier/';
		...
		public function register_panel() {
			...
			$admin_tabs['exclusions'] = esc_html__( 'Exclusion List', 'yith-woocommerce-zoom-magnifier' );
		...
		public function register_pointer() {
			...
			$args[] = array(
				...
				'content'    => sprintf(
					...
					esc_html__( 'In YITH Plugins tab you can find  YITH WooCommerce Product Gallery & Image Zoom  options.<br> From this menu you can access all settings of the YITH plugins activated.', 'yith-woocommerce-zoom-magnifier' ) . '<br>' . $premium_message
				),
				'position'   => array(
					'edge'  => 'left',
					'align' => 'center',

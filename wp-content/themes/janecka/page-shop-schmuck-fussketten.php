...
/**
* Template Name: Seite Shop Fussketten
* Template Description: Shop-Bereich für Fussketten
*/
		...
		<article class="columns shop-overview__columns">
			<section class="content-shop container column content-shop__column-filters">
				<aside class="sidebar-filters">
					<?php echo do_shortcode ('[yith_wcan_filters slug="filter-set-fussketten"]') ?>
				</aside>
			</section>

			<section class="content-shop container column content-shop__column-products">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="3" category="fussketten" paginate="true"]') ?>
				</div>
			</section>
		</article>

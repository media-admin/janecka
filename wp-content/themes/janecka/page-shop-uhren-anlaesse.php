	...
	<main class="site-main content">
		...
		<article class="columns shop-overview__columns">
			...
			<section class="content-shop container column content-shop__column-products">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="3" category="uhren" attribute="anlass" terms="taufe,firmung,geburtstag,jubilaeum,morgengabe,valentinstag" paginate="true"]') ?>
				</div>
			</section>
		</article>

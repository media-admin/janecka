...
/**
* Template Name: Seite Shop Solitärschmuck
* Template Description: Shop-Bereich für Solitärschmuck
*/
		...
		<article class="columns shop-overview__columns">
			<section class="content-shop container column content-shop__column-filters">
				<aside class="sidebar-filters">
					<?php echo do_shortcode ('[yith_wcan_filters slug="schmuck-solitaerschmuck"]') ?>
				</aside>
			</section>

			<section class="content-shop container column content-shop__column-products">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="3" category="solitaire-schmuck" paginate="true"]') ?>
				</div>
			</section>
		</article>

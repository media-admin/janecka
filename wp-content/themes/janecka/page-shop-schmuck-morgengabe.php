...
/**
* Template Name: Seite Shop Schmuck Morgengabe
* Template Description: Shop-Bereich für Morgengaben-Schmuck
*/
	...
	<main class="site-main content">
		...
		<article class="shop-overview__columns--one-column" id="product-grid">
			...
			<section class="container content-shop__column-products--one-column">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="4" category="schmuck" attribute="anlass" terms="morgengabe" paginate="true"]') ?>
				</div>
			</section>
		</article>

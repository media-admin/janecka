...
/**
* Template Name: Seite Shop Armschmuck
* Template Description: Shop-Bereich für Armschmuck
*/
		...
		<article class="shop-overview__columns--one-column" id="product-grid">
			<section class="container content-shop__column-filters--one-column">
				<aside class="sidebar-filters">
					<?php echo do_shortcode ('[yith_wcan_filters slug="draft-preset-3-2-2"]') ?>
				</aside>
			</section>

			<section class="container content-shop__column-products--one-column">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="4"category ="armschmuck" cat_operator="OR" paginate="true"]') ?>
				</div>
			</section>
		</article>

...
/**
* Template Name: Seite Shop Uhren
* Template Description: Shop-Bereich für Uhren
*/
		...
		<article class="columns shop-overview__columns">
			...
			<section class="content-shop container column content-shop__column-filters">
				<aside class="sidebar-filter">
					<?php echo do_shortcode ('[yith_wcan_filters slug="uhren-gesamt"]') ?>
				</aside>
			</section>

			<section class="content-shop container column content-shop__column-products">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="3" category = "uhren" paginate="true"]') ?>
				</div>
			</section>

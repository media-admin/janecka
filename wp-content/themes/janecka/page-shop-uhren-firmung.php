...
/**
* Template Name: Seite Shop Uhren Firmung
* Template Description: Shop-Bereich für Uhren zur Firmung
*/
	...
	<main class="site-main content">
		...
		<article class="columns shop-overview__columns">
			...
			<section class="content-shop container column content-shop__column-products">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="3" category="uhren" attribute="anlass" terms="firmung" paginate="true"]') ?>
				</div>
			</section>
		</article>

...
/**
* Template Name: Seite Filiale GABUTT
* Template Post Type: storessss
						...
						(function( jQuery ) {
								...
								function initMarker( $marker, map ) {
									...
									var marker = new google.maps.Marker({
										position : latLng,
										map: map,
										// icon:  'https://www.glamur.at/cms/wp-content/themes/glamur/assets/logos/Logo_GlaMUR_map-icon.png'
									});
		...
		<section class="brands-area container">
			...
			<?php
				...
				if( $brandNames ):
					...
					$j = 0; // Counter für Betriebe-Anzahl //
					$k = 0; // Counter für Produkte-Anzahl //

...
/**
* Template Name: Seite Shop Uhren Geburtstag
* Template Description: Shop-Bereich für Uhren zum Geburtstag
*/
	...
	<main class="site-main content">
		...
		<article class="shop-overview__columns--one-column" id="product-grid">
			...
			<section class="container content-shop__column-products--one-column">
				<div class="container">
					<?php echo do_shortcode ('[products limit="60" columns="4" category="uhren" attribute="anlass" terms="geburtstag" paginate="true"]') ?>
				</div>
			</section>
		</article>
